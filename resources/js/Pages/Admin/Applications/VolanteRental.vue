            ...
            <div v-if="drawerData">
                 <div class="ml-auto w-full max-w-xl bg-white shadow-lg h-full overflow-y-auto">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                        <p class="font-semibold text-primary">{{ `Market Volante Rental Application (${drawerData?.permits?.type})` }}</p>
...
watch(
  forms,
  throttle(() => {
    router.get(`/admin/rental-management/market-volante`, pickBy(forms), { preserveState: true })
  }, 150),
  { deep: true }
);
