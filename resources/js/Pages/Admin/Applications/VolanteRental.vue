...
<template>
    <AppLayout title="Volante">
        ...
        <h1 class="mb-8 text-3xl font-bold text-primary">Volante</h1>
            ...
            <div v-if="drawerData">
                 <div class="ml-auto w-full max-w-xl bg-white shadow-lg h-full overflow-y-auto">
                    ...
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                        <p class="font-semibold text-primary">{{ `Volante Rental Application (${drawerData?.permits?.type})` }}</p>
                        ...
                        <ul class="space-y-2 text-sm">
                            ...
                            <li class="flex items-center space-x-2">
                                ...
                                <span>
                                    ...
                                    <span class="text-gray-600"> {{ drawerData?.location }}</span>
                                </span>
                            </li>
                            <li class="flex items-center space-x-2">
                                <!-- Calendar SVG -->
                            ...
                            <li class="flex items-center space-x-2">
                                ...
                                <span>
                                    ...
                                    <span class="text-gray-600"> {{durationsOptions?.find((item) => item.id === drawerData?.duration)}}</span>
                                </span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="p-4 border rounded-xl">
                        <h3 class="text-md font-semibold mb-3 text-primary">Payments</h3>
                         <ul class="space-y-2 text-sm">
                            ...
                            <li class="flex items-center space-x-2">
                              <span>
                                <strong class="text-secondary">Weeks: </strong>
                                <span class="text-gray-600"> {{`${drawerData?.payments?.weeks}` }}</span>
                                </span>
                            </li>
                            <li class="flex items-center space-x-2">
                            <ul class="space-y-2">
...
import { formatAmount, formatDate, formatDateShort } from '@/data/helper';
...
watch(
  forms,
  throttle(() => {
    router.get(`/admin/applications/volantes`, pickBy(forms), { preserveState: true })
  }, 150),
  { deep: true }
);
...
const rejectConfirm = () => {
    delete form.remarks;
    form.put(route('department.applications.volantes.reject', drawerData?.value?.id));
};
</script>
