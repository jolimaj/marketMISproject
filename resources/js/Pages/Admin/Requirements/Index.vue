...
<template>
    <AppLayout title="Requirements">
        ...
        <h1 class="mb-8 text-3xl font-bold text-primary">Requirements</h1>
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <BaseTable :headers="headers" :data="requirementsList?.data">
                ...
                <template #row="{ data }">
                    ...
                    <tr v-if="requirementsList?.total === 0">
        ...
        <div class="mt-6 flex justify-center">
            <pagination :links="requirementsList?.links" />
        </div>
    </AppLayout>
</template>
...
watch(
  form,
  throttle(() => {
    router.get(`/admin/system-setting/requirements`, pickBy(form), { preserveState: true })
  }, 150),
  { deep: true }
);
