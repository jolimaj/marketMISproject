...
class TablesRequest extends FormRequest
{
    ...
    {
        $tableRentalId = $this->route('tableRental') ? $this->route('tableRental')->id : null;
        Log::info('tableRentalRequest rules called', [
        ...
        return [
            ...
            'business_name' => [
                ...
                'string',
                'max:255',
                Rule::unique('stall_rentals')->ignore($tableRentalId)
            ],
